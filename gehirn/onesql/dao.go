...
type FastDaoImpl[SvcObj any, DObj zsql.DataObj[SvcObj]] struct {
...
func (dao *FastDaoImpl[SvcObj, DObj]) TableName() string { return dao.tableName() }

func (dao *FastDaoImpl[SvcObj, DObj]) Omits() []string { return dao.omits() }

func (dao *FastDaoImpl[SvcObj, DObj]) Init(cons zsql.SqlConstructor, tableName func() string, omits func() []string, b zsql.BindFunc) {
...
func (dao *FastDaoImpl[SvcObj, DObj]) GetScanner() zsql.ScannerProxy {
	return dao._scanner
}

func (dao *FastDaoImpl[SvcObj, DObj]) GetBuilder() zsql.BuilderProxy {
	return dao._builder
}

func (dao *FastDaoImpl[SvcObj, DObj]) SelectOne(ctx context.Context, db zsql.XDB, where map[string]interface{}) (res DObj, err error) {
	if nil == db {
...
func (dao *FastDaoImpl[SvcObj, DObj]) SelectMulti(ctx context.Context, db zsql.XDB, where map[string]interface{}) (res []DObj, err error) {
	if nil == db {
		return res, errors.New("manager.XDB object couldn't be nil")
	}
...
func (dao *FastDaoImpl[SvcObj, DObj]) Insert(ctx context.Context, db zsql.XDB, data []map[string]interface{}) (int64, error) {
	if nil == db {
...
func (dao *FastDaoImpl[SvcObj, DObj]) Update(ctx context.Context, db zsql.XDB, where, data map[string]interface{}) (int64, error) {
	if nil == db {
		return 0, errors.New("manager.XDB object couldn't be nil")
	}
...
func (dao *FastDaoImpl[SvcObj, DObj]) Delete(ctx context.Context, db zsql.XDB, where map[string]interface{}) (int64, error) {
	if nil == db {
		return 0, errors.New("manager.XDB object couldn't be nil")
	}
...
func (dao *FastDaoImpl[SvcObj, DObj]) CountOf(ctx context.Context, db zsql.XDB, where map[string]interface{}) (count int, err error) {
	if nil == db {
		return 0, errors.New("manager.XDB object couldn't be nil")
	}
...
func (dao *FastDaoImpl[SvcObj, DObj]) ToEntity(ctx context.Context, t DObj) *SvcObj {
	return t.ToEntity(ctx)
}

func (dao *FastDaoImpl[SvcObj, DObj]) MultiToEntity(ctx context.Context, ts []DObj) []*SvcObj {
	var res []*SvcObj
	for _, t := range ts {

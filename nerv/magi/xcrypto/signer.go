...
func (s *signer) SignValues(ctx context.Context, values url.Values, opts ...SignOption) ([]byte, error) {
...
func (s *signer) SignBytes(ctx context.Context, data []byte, opts ...SignOption) ([]byte, error) {
	var buffer = s.getBuffer()
	defer s.putBuffer(buffer)
...
func (s *signer) VerifyValues(ctx context.Context, values url.Values, signature []byte, opts ...SignOption) error {
	var buffer = s.getBuffer()
	defer s.putBuffer(buffer)
...
func (s *signer) VerifyBytes(ctx context.Context, data []byte, signature []byte, opts ...SignOption) error {
	var buffer = s.getBuffer()
	defer s.putBuffer(buffer)

 ...
 *　　   ┃┫┫  ┃┫┫
 *      ┗┻┛　 ┗┻┛
 @Time    : 2024/11/4 -- 17:16
 @Author  : 亓官竹 ❤️ MONEY
 @Copyright 2024 亓官竹
 @Description: xatomic.go
*/

package xsync

import (
	"github.com/qiguanzhu/infra/seele/zatomic"
	"sync"
	"sync/atomic"
	"time"
)
...
func NewAtomicInt32(n int32) zatomic.ZAtomicNumLike[int32] {
...
func NewAtomicInt64(n int64) zatomic.ZAtomicNumLike[int64] {
...
func NewAtomicDuration(duration time.Duration) zatomic.ZAtomicNumLike[time.Duration] {
...
func NewAtomicBool(n bool) zatomic.ZAtomic[bool] {
	if n {
		return &AtomicBool{1}
	}
	return &AtomicBool{0}
...
// NewAtomicString initializes a new NewAtomicString with a given str.
func NewAtomicString(str string) zatomic.ZAtomic[string] {
	return &AtomicString{
		str: str,
		mu:  sync.Mutex{},
	}
